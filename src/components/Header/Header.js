          ...
          <div className="header__nav-links" id="header__nav-links">
            <ul>
              ...
              <div className="header__social">
                <p className='header__spotify'>
                  <a href="https://open.spotify.com/artist/2IXr4kLYxg0zhX049pfW6g" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faYoutube} size="2x" /></a>
                </p>
                <p className='header__youtube'>
                  <a href="https://www.youtube.com/@tryfactaofficial8818" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faYoutube} size="2x" /></a>
                </p>
                <p className='header__soundcloud'>
                  <a href="https://soundcloud.com/user-205982868" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faYoutube} size="2x" /></a>
                </p>
              </div>
            ...
            {/* <div className="contact__social">
              <p className='Spotify'><FontAwesomeIcon icon="fa-brands fa-spotify" /></p>
